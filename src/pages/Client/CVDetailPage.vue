<template>
  <div class="container-fluid flex mt-5">
    <div
      id="sidebar"
      class="bg-lightblue w-[600px] h-screen overflow-y-scroll d-grid p-5"
    >
      <!-- LANGUAGE SETTING -->
      <!-- <div class="section">
      ...
      <!-- COLOR SETTING -->
      <div class="section">
        <h1 class="text-xl capitalize transition-all mt-14">
          {{ store_setting.cv_data.settings.languages.cv_colors }}
        </h1>
        <ul class="flex flex-wrap gap-3 mt-5">
          ...
          <li v-for="color in cv_colors" :key="color">
            <button
              ...
              class="w-8 h-8 rounded-xl active:scale-90"
      ...
      >
        <span>{{
          store_setting.cv_data.settings.languages.cv_personal_details
        }}</span>
      ...
      <Collapse :when="isOpen" class="collapse">
        <div class="bg-white rounded-xl p-4 mb-6">
          <div class="inputs flex w-full gap-4">
            ...
            <div class="input">
              <label for="first_name">{{
                store_setting.cv_data.settings.languages.first_name
              }}</label>
              <input
                id="first_name"
                type="text"
                ...
                v-model="store_setting.cv_data.personal_details.first_name"
              />
            </div>
            <!-- LAST NAME -->
            <div class="input">
              <label for="last_name">{{
                store_setting.cv_data.settings.languages.last_name
              }}</label>
              <input
                id="last_name"
                type="text"
                ...
                class="w-full mt-2 min-w-0 flex-auto rounded-lg px-4 py-2 text-dark shadow-sm ring-0"
                v-on:keyup="store_setting.cv_save"
                v-model="store_setting.cv_data.personal_details.last_name"
              />
            </div>
          </div>
          <!-- JOB TITLE -->
          <div class="input mt-5">
            <label for="job_title">{{
              store_setting.cv_data.settings.languages.job_title
            }}</label>
            <input
              id="job_title"
              type="text"
              ...
              class="w-full mt-2 min-w-0 flex-auto rounded-lg px-4 py-2 text-dark shadow-sm ring-0"
              v-on:keyup="store_setting.cv_save"
              v-model="store_setting.cv_data.personal_details.job_title"
            />
          </div>
          <!-- EMAIL -->
          <div class="input mt-5">
            <label for="email">{{
              store_setting.cv_data.settings.languages.email
            }}</label>
            <input
              id="email"
              type="email"
              ...
              class="w-full mt-2 min-w-0 flex-auto rounded-lg px-4 py-2 text-dark shadow-sm ring-0"
              v-on:keyup="store_setting.cv_save"
              v-model="store_setting.cv_data.personal_details.email"
            />
          </div>
          <!-- PHONE -->
          <div class="input mt-5">
            <label for="phone">{{
              store_setting.cv_data.settings.languages.phone
            }}</label>
            <input
              id="phone"
              type="text"
              ...
              class="w-full mt-2 min-w-0 flex-auto rounded-lg px-4 py-2 text-dark shadow-sm ring-0"
              v-on:keyup="store_setting.cv_save"
              v-model="store_setting.cv_data.personal_details.phone"
            />
          </div>
          <!-- LOCATION -->
          <div class="input mt-5">
            <label for="location">{{
              store_setting.cv_data.settings.languages.location
            }}</label>
            <input
              id="location"
              type="text"
              ...
              class="w-full mt-2 min-w-0 flex-auto rounded-lg px-4 py-2 text-dark shadow-sm ring-0"
              v-on:keyup="store_setting.cv_save"
              v-model="store_setting.cv_data.personal_details.location"
            />
          </div>
          <!-- ABOUT ME -->
          <div class="input mt-5">
            ...
            <textarea
              ...
              v-on:keyup="store_setting.cv_save"
              v-model="store_setting.cv_data.personal_details.about_me"
            >
            </textarea>
          </div>
        </div>
        ...
        <div class="bg-white rounded-xl p-4 mb-6">
          <div class="inputs w-full gap-4">
            ...
            <div class="input">
              ...
              <input
                ...
                v-on:change="store_setting.cv_save"
              ...
              <input
                ...
                autocomplete="off"
                class="w-full mt-2 min-w-0 flex-auto rounded-lg px-4 py-2 text-dark shadow-sm ring-0"
                v-model="store_setting.cv_data.skills.tech"
                v-on:keyup="store_setting.cv_data_tech_add"
              />
            </div>
          </div>
          <div class="inputs w-full gap-4 mt-5">
            ...
            <div class="input">
              ...
              <input
                ...
                autocomplete="off"
                class="w-full mt-2 min-w-0 flex-auto rounded-lg px-4 py-2 text-dark shadow-sm ring-0"
                v-model="store_setting.cv_data.skills.soft"
                v-on:keyup="store_setting.cv_data_soft_add"
              />
            </div>
          </div>
          ...
          <div class="inputs w-full gap-4 mt-5">
            <div class="">
              ...
              <div
                class="input"
                v-for="l in store_setting.cv_data.skills.language"
                :key="l"
              >
                ...
                <div class="flex align-middle gap-4">
                  <input
                    type="range"
                    class="w-full mt-2 min-w-0 flex-auto px-4 py-2"
                    min="10"
                    max="100"
                    step="10"
                    v-model="l.level"
            ...
            <button
              @click="store_setting.add_language_cv_data()"
          ...
          <div class="inputs w-full">
            ...
            <div class="input">
              ...
              <input
                ...
                v-on:keyup="store_setting.cv_save"
                v-model="store_setting.cv_data.socials.github"
              />
            </div>
            <div class="input mt-4">
              <label for="twitter" class="flex gap-2">
                <img
                  src="../../components/svg/twitter.svg"
                  width="18"
                  alt="twitter"
                />
                twitter
              ...
              <input
                ...
                class="w-full mt-2 flex-auto rounded-lg px-4 py-2 text-dark shadow-sm ring-0"
                v-on:keyup="store_setting.cv_save"
                v-model="store_setting.cv_data.socials.twitter"
              />
            </div>
            <div class="input mt-4">
              <label for="instagram" class="flex gap-2">
                <img
                  src="../../components/svg/instagram.svg"
                  width="18"
                  alt="instagram"
                />
                instagram
              ...
              <input
                ...
                class="w-full mt-2 flex-auto rounded-lg px-4 py-2 text-dark shadow-sm ring-0"
                v-on:keyup="store_setting.cv_save"
                v-model="store_setting.cv_data.socials.instagram"
              />
            </div>
            <div class="input mt-4">
              <label for="linkedin" class="flex gap-2">
                <img
                  src="../../components/svg/linkedin.svg"
                  width="18"
                  alt="linkedin"
                />
                linkedin
              ...
              <input
                ...
                class="w-full mt-2 flex-auto rounded-lg px-4 py-2 text-dark shadow-sm ring-0"
                v-on:keyup="store_setting.cv_save"
                v-model="store_setting.cv_data.socials.linkedin"
              />
            </div>
            <div class="input mt-4">
              <label for="telegram" class="flex gap-2">
                <img
                  src="../../components/svg/telegram.svg"
                  width="18"
                  alt="telegram"
                />
                telegram
              ...
              <input
                ...
                class="w-full mt-2 flex-auto rounded-lg px-4 py-2 text-dark shadow-sm ring-0"
                v-on:keyup="store_setting.cv_save"
                v-model="store_setting.cv_data.socials.telegram"
              />
            </div>
            <div class="input mt-4">
              <label for="web" class="flex gap-2">
                <img src="../../components/svg/web.svg" width="18" alt="web" />
              ...
              <input
                ...
                class="w-full mt-2 flex-auto rounded-lg px-4 py-2 text-dark shadow-sm ring-0"
                v-on:keyup="store_setting.cv_save"
                v-model="store_setting.cv_data.socials.web"
              />
            </div>
          </div>
        </div>
      ...
      <Collapse :when="isOpen3" class="collapse">
        <div class="bg-white rounded-xl p-4 mb-6">
          <div class="inputs w-full">
            ...
            <div
              class="input mb-3"
              v-for="e in store_setting.cv_data.experiences"
              :key="e"
            >
              <div
                class="w-full bg-lightblue mt-5 mb-5 text-center uppercase"
                v-if="e.title"
              >
                {{ e.title }}
              </div>
              ...
              <div class="flex gap-2 w-full justify-between">
                ...
                <input
                  ...
                  class=""
                  v-on:change="store_setting.cv_save"
                  v-model="e.isExperience"
                />
              </div>
              <label for="">{{
                store_setting.cv_data.settings.languages.title
              }}</label>
              <input
                type="text"
                autocomplete="off"
              ...
              <div class="flex gap-4 w-full">
                <div class="input mt-4">
                  <label>{{
                    store_setting.cv_data.settings.languages.from
                  }}</label>
                  <input
                    type="text"
                    autocomplete="off"
                ...
                <div class="input mt-4">
                  <label>{{
                    store_setting.cv_data.settings.languages.to
                  }}</label>
                  <input
                    type="text"
                    autocomplete="off"
              ...
              <div class="input mt-5">
                <label for="about_me">{{
                  store_setting.cv_data.settings.languages.summary
                }}</label>
                <textarea
                  id="about_me"
                  type="text"
          ...
          <button
            @click="store_setting.add_experience_cv_data()"
            class="w-full transition bg-lightblue p-2.5 rounded-lg active:bg-lightblue hover:bg-gray-light"
          >
      ...
      <Collapse :when="isOpen4" class="collapse">
        <div class="bg-white rounded-xl p-4 mb-6">
          <div class="inputs w-full">
            ...
            <div
              class="input mb-3"
              v-for="e in store_setting.cv_data.educations_and_certifications"
              :key="e"
            >
              <div
                class="w-full bg-lightblue mt-5 mb-5 text-center uppercase"
              ...
              <div class="flex gap-2 w-full justify-between">
                <label>
                  {{
                    store_setting.cv_data.settings.languages
          ...
          <button
            @click="store_setting.add_educations_and_certifications_cv_data()"
            class="w-full transition bg-lightblue p-2.5 rounded-lg active:bg-lightblue hover:bg-gray-light"
          >
            {{
              store_setting.cv_data.settings.languages
                .add_educations_and_certifications
            }}
          </button>
        </div>
      </Collapse>
      ...
      <button
        class="btn rounded-xl w-full text-sm mt-5 text-white bg-black delay-200 transition p-3 hover:delay-0"
        @click="handleSave"
      >
        Update
      </button>
  ...
  detailHienThi.value = {
    settings: {
      languages: {
        ...
        cv_colors: "Colors",
        cv_personal_details: "Personal information",
        first_name: "Last name",
        last_name: "First name",
        job_title: "Position" / "Current position",
        about_me: "About",
        contact: "Contact",
        email: "Email",
        phone: "Phone number",
        ...
        to: "To",
        summary: "Summary",
        educations_and_certifications: "Education",
        add_educations_and_certifications: "Add education",
      },
      colors: "#000",
      buttons: {
        print_or_download: "Print or download (PDF)",
        download_as_json: "Download as JSON",
        update_json_file: "Upload JSON file",
        remove_all_data: "Remove all information",
      },
    },
    personal_details: {
